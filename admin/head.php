  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.php"><img src="../images/logo.png" title="柒天工作室" alt="柒天工作室" /></a>
      </div>
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-format-list-bulleted"></i>导航栏管理</a>
            ...
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(1)"><i class="mdi mdi-palette"></i> 网站信息</a>
              <ul class="nav nav-subnav">
                <li> <a href="set.php?mod=site">网站设置</a> </li>
			  <li><a href="./logo.php?mod=logo">设置logo</a></li>
                <li> <a href="./logo.php?mod=bj">设置背景图</a> </li>
              </ul>
            </li>
            <li class="nav-item"> 
            <a href="http://wpa.qq.com/msgrd?v=3&uin=0000001&site=qq&menu=yes">
        ...
        <div class="sidebar-footer">
          <p class="copyright">Copyright &copy; 2019. <a target="_blank" href=""><?php echo $conf['sitename']; ?></a></p>
        </div>
      </div>
